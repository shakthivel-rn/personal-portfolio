...
export default function Page() {
  return <div>
    <div className={styles.aboutMe}>
      <span>With a Master of Science in Software Engineering from San Jose State University and a Bachelor of Engineering in Computer Science from College of Engineering, Guindy, I have cultivated a robust foundation in both the theoretical and practical aspects of software engineering. My path in technology encompasses a solid education, practical internships, and meaningful projects, culminating in my current position as a Software Engineer at iHeartMedia.
      </span>
      <span>During my time at iHeartMedia, I have contributed to the development of key applications in the Music Lab and AI Music Scheduler projects, using technologies like Python, TypeScript, and React. I have engineered efficient user management systems, built reusable React components to enhance UI consistency, and optimized backend systems with advanced indexing in AWS DynamoDB, significantly improving performance and reducing latency
      </span>
    </div>
